    ...
    match lexic[0]:
        ...
        case "nand":
            ...
            if lexic[2] != '0' and lexic[2] != '1':
                ...
                args.append(int(lexic[2]))
            line = line.replace(line[start_ind:end_ind] + '}', str(int(not (args[0] and args[1]))))
        ...
        case "nor":
            ...
            if lexic[2] != '0' and lexic[2] != '1':
                ...
                args.append(int(lexic[2]))
            line = line.replace(line[start_ind:end_ind] + '}', str(int(not (args[0] or args[1]))))
        ...
        case "xor":
            ...
            if lexic[2] != '0' and lexic[2] != '1':
                ...
                args.append(int(lexic[2]))
            line = line.replace(line[start_ind:end_ind] + '}', str(int(not((args[0] and args[1]) or (not (args[0] or args[1]))))))
        ...
        case "xnor":
            ...
            if lexic[2] != '0' and lexic[2] != '1':
                ...
                args.append(int(lexic[2]))
            line = line.replace(line[start_ind:end_ind] + '}', str(int((args[0] and args[1]) or (not (args[0] or args[1])))))
...
for i in range(len(code.split('\n'))):
    ...
    match lexic[0]:
        ...
        case "nand":
            ...
            print(f"NAND output : {int(not (args[0] and args[1]))}. Line : {i + 1}")
        ...
        case "or":
            ...
            print(f"OR output : {int(args[0] or args[1])}. Line : {i + 1}")
        ...
        case "nor":
            ...
            print(f"NOR output : {int(not (args[0] or args[1]))}. Line : {i + 1}")
        ...
        case "xor":
            ...
            if lexic[2] != '0' and lexic[2] != '1':
                ...
                args.append(int(lexic[2]))
            print(f"XOR output : {int(not((args[0] and args[1]) or (not (args[0] or args[1]))))}. Line : {i + 1}")
        ...
        case "xnor":
            ...
            if lexic[2] != '0' and lexic[2] != '1':
                ...
                args.append(int(lexic[2]))
            print(f"XNOR output : {int((args[0] and args[1]) or (not (args[0] or args[1])))}. Line : {i + 1}")
